...
class FaceGraphic constructor(overlay: GraphicOverlay?, private val face: Face) : GraphicOverlay.Graphic(overlay) {
  ...
  override fun draw(canvas: Canvas) {
    ...
    canvas.drawText("X: " + face.boundingBox.left, left, top + yLabelOffset, idPaints[colorID])
    yLabelOffset += lineHeight
    canvas.drawText("Y: " + face.boundingBox.top, left, top + yLabelOffset, idPaints[colorID])
    yLabelOffset += lineHeight
